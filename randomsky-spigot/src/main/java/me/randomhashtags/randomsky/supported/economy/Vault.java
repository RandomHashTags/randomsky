...
public final class Vault implements UVersionable {
    ...
    public Chat getChat() {
        if(chat == null) {
            final RegisteredServiceProvider<Chat> rsp = servicesManager.getRegistration(Chat.class);
    ...
    public Permission getPermission() {
        if(permissions == null) {
            final RegisteredServiceProvider<Permission> rsp = servicesManager.getRegistration(Permission.class);
