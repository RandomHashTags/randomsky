...
public interface EventAttribute extends Cancellable, Identifiable, Mathable {
    ...
    void executeData(@NotNull HashMap<RSPlayer, String> recipientValues, @NotNull HashMap<String, String> valueReplacements);
    void executeData(@NotNull HashMap<String, Entity> entities, @NotNull HashMap<RSPlayer, String> recipientValues, @NotNull HashMap<String, String> valueReplacements);
}
