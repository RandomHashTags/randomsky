...
public class CoinFlip extends RSFeature implements CommandExecutor {
    ...
    protected RSFeature getFeature() { return getCoinFlip(); }
    ...
    private void chooseWinner(CoinFlipMatch m) {
        ...
        final RSPlayer W = RSPlayer.get(winner.getUniqueId()), ll = RSPlayer.get(loser.getUniqueId());
        ...
        for(Player p : Bukkit.getOnlinePlayers()) {
            if(RSPlayer.get(p.getUniqueId()).coinflipNotifications) {
